...
{
    public static class InternalLogs
    {
        private const string LogFile = @"InternalLogs.txt";
        private static readonly string Output = ReportHelper.Configuration.LocalOutputPath ?? @"C:\AutomationReport";
