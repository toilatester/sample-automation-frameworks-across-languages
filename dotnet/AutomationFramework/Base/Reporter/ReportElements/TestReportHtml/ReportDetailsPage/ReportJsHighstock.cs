...
{
    public class ReportJsHighstock
    {
        ...
        public ReportJsHighstock (List<TestInformations> test, List<Remark> testRemarks, string chartId)
        {
            var orderedList = test.OrderBy(x => x.DateTimeFinish);
            ...
            foreach (var eventList in allEvents)
            {
                ...
                testEventsData += string.Format(@"{{
                                ...
                                fillColor : '{2}',
                                color : '{2}'
                            }}, " + Environment.NewLine, eventList.First().Name, eventData, ReportColors.Black, ReportColors.TestBorderColor);
            }
            ...
            JsCode = string.Format(@"
                ...
                }});", chartId, testsData, ReportColors.TestBorderColor, testsScreenshotsData, ReportColors.BodyBackground, testEventsData, testRemarksData, ReportColors.Remarks);
        }
    }
}
