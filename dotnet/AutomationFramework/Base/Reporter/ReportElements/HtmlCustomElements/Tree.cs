...
namespace AutomationFrameWork.Reporter.ReportElements
{
	...
	{
        private static void BuildTreeFromSuites(this HtmlTextWriter writer, IEnumerable<TestSuiteInformations> suites)
        {
        ...
        public static string GetTreeCode(List<TestInformations> tests)
		{
			...
			using (var writer = new HtmlTextWriter(strWr))
			{
			    writer
			        .Id("tests-tree")
			        .Div(() => writer
			            .BuildTreeFromSuites(new List<TestSuiteInformations>
			            {
